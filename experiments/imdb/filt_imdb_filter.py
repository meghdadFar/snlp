...
from snlp.data_processing.processing import preprocess_dataframe, create_filterset_map, create_filterset
...
def run_cleaning_map(raw_home, output_home, z_map, regex_pattern):
    ...
    try:
        ...
        for set_name in tqdm(cv_sets):
            preprocess_dataframe(os.path.join(raw_home, set_name),
